...
Connects to the EVE-NG telnet console at localhost:32792 and switches to
QEMU monitor mode via Ctrl+A C, then injects sendkey commands into the
VM's VGA console.
...
Usage:
  python3 freebsd14_firstboot.py           # system already booted
  python3 freebsd14_firstboot.py --wait    # wait 150s for FreeBSD to boot
"""
import socket, time, sys

CONSOLE_PORT = 32792  # EVE-NG telnet console for node 24 (freebsd14)
