...
echo
echo " 2. MikroTik nodes hit a first-boot password prompt before accepting config."
echo "    On each MikroTik console, type:"
echo "      new password>          lab123"
echo "      confirm new password>  lab123"
echo "    Affected nodes: CPE1-5 (32777-32781), ACDC_SITE_A/B (32787-32788),"
echo "                    SWANS_SITE_A/B (32789-32790), ACDC_HOST (32791)"
echo "    After the password is set the startup-config is applied automatically."
echo
echo " 3. Cisco nodes load startup-config automatically."
...
echo
echo " 4. FreeBSD nodes need first-boot config:"
...
echo
echo " 5. Live-apply Cisco running config:"
